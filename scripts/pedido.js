...
const PRECIO_UNIDAD = 550;


const botonAgregar = document.createElement('button');
botonAgregar.id = 'boton-agregar';
botonAgregar.textContent = 'Agregar Factura';
...
const crearMenuDeOpciones = async (url) => {
    ...
    titulo.innerHTML = '<h3>Agrega tus facturas:</h3>';
    ...
    data.facturas.forEach(factura => {
        id++;
        const opcion = agregarOpcionAlMenuOpciones(factura.sabor, id);
